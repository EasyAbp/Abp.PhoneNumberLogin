...
namespace PhoneNumberLoginSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update PhoneNumberLoginSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update PhoneNumberLoginSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity

...
{
    public static class PhoneNumberLoginSampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE PhoneNumberLoginSampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
